'''
DFS로 안되어 BFS로 구현해 본 코드이다.
이제 BFS 알고리즘을 어떻게 구현해야 하는지 알았지만 DP & BFS를 이용하여 문제를 풀어 나가는 것에 대해선 아직 미숙한 것 같다.

이번 문제를 통해 깨달은 것
1. BFS & DP를 같이 이용하여 문제를 풀어나가는 방법
2. 뭔가 앞에서 썼던 데이터를 다시 사용할 경우 DP, 그리고 BFS를 생각하자.
'''
